<?php include 'service_functions.php'; ?>
<!doctype html>
<html lang="en">
...
<div class="container mb-5" >
          ...
          <tbody>
            <?php foreach ($result as $res) { ?>
              <tr>
                ...
                <td><img src='./img/service/<?php echo $res->photo; ?>' class="rounded mx-auto d-block w-25"></td>
                <td class='block'>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Змінити послугу</h5>
                    ...
                    <div class="modal-body">
                      <form action="?id=<?php echo $res->id; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          <small>Фото</small>
                          <img src='./img/service/<?php echo $res->photo; ?>' class="d-block w-50">
            ...
            <div class="modal fade" id="delete<?php echo $res->id; ?>" role="dialog" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Точно видалити послугу "<?php echo $res->Name; ?>"</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-footer">
  ...
  <div class="modal fade" id="create" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Додати послугу</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
