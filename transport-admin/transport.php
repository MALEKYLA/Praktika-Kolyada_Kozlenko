<?php include 'transport_functions.php'; ?>
<!doctype html>
<html lang="en">
  ...
  <div class="container mb-5">
    <header class="d-flex flex-wrap justify-content-around py-3 border-bottom">
      <ul class="nav d-flex nav-pills flex-wrap justify-content-between mt-3">
        ...
        <li class="nav-item"><a href="./transport.php" class="nav-link m-2 active">Транспорт</a></li>
      </ul>
    </header>
  </div>
  </div>
          ...
          <tbody>
            <?php foreach ($result as $res) { ?>
              <tr>
                ...
                <td><img src='./img/transport/<?php echo $res->photo; ?>' class="rounded mx-auto d-block w-50"></td>
                <td class='block'>
                    ...
                    <div class="modal-body">
                      <form action="?id=<?php echo $res->id; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="purpose" value='<?php echo $res->Purpose; ?>'>
                        </div>
                        <div class="form-group">
                          <small>Опис</small>
                        ...
                        <div class="form-group">
                          <small>Фото</small>
                          <img src='./img/transport/<?php echo $res->photo; ?>' class="d-block w-50">
              ...
              <div class="modal fade" id="delete<?php echo $res->id; ?>" role="dialog" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Точно видалити транспорт "<?php echo $res->Name; ?>"</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-footer">
