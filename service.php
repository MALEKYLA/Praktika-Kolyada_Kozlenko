 ...
 <div style="background-color: #ffffff;">
  ...
  <ul class="dropdown-menu dropdown-menu-start" aria-labelledby="dropdownMenuButton1" style="border-radius: 20px; width: 200px; background-color: #e0e0e0;">
        ...
        <li><hr class="dropdown-divider"></li>
         ...
         <li><a href="./service.php"  class="dropdown-item active" >Послуги</a></li>
...
.bluecard{
 ...
 <div class="container-header">
  <img src="./assets/nafto.jpg" alt="Snow" style="width:100%;">
  <div class="centered card p-5">
  <h1 class="card-title">ПОСЛУГИ</h1>
    <h6 class="mt-3 card-text">Техніка потребує регулярного обслуговування, тому ми радимо вам не нехтувати послугами сервісного центру. 
      До того ж, у нас спеціалісти з досвідом роботи від 10-х років, які привели до ладу вже більше 1000 одиниць техніки. 
      Якщо хочете проконсультуватись із професіоналом або записатись на обслуговування прямо зараз, зателефонуйте нам.</h6>
      <h3 class="mt-3">+38 (050) 304 55 34</h3>
  </div>
</div>

<div class="container w-50 justify-content-center">
  <h1 class="pt-3 text-center">Наші послуги</h1>
  <div class="container w-50 pt-2 pb-4 justify-content-center">
  <h6 class="text-left">
  Наш сервісний центр здатний виконати всі можливі види послуг, щодо обслуговування, ремонту, а також заміни запчастин спеціалізованої техніки. 
  Працюємо згідно договору, погоджуємо всі деталі з замовнком, виконуємо задачі чітко, дотримуємось заданого дедлайну. Виготовляємо спецтехніку за індивідуальними проектами.
  </h6>
  </div>
</div>
...
<?php 
  foreach($result as $res){ 
    ?>
  <div class="card bluecard p-4 my-5">
  <div class="row align-items-start">
    <div class="col">
      <img class="w-100" src="http://transport-admin/img/service/<?php echo $res->photo; ?>">
    </div>
    <div class="col pl-5">
      <h4 class="mt-3  mx-5">
      <?php echo $res->Name; ?>
...
<div class="container" >
     <header class="d-flex flex-wrap justify-content-around py-3 border-bottom">
       <ul class="nav d-flex nav-pills flex-wrap justify-content-between mt-3">
         ...
         <li class="nav-item"><a href="./service.php" class="nav-link m-2 active">Послуги</a></li>
